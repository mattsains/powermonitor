...
class Plotter():
    ...
    def ewmaResampling(self, dataFrameIn, weight = 1, freqVal='1min', minPeriodsVal=10):
        ...
        result = pd.ewma(dataFrameIn.reading,amountOfWeight,freqVal,min_periodsVal)
        return result

    def plotDataBetweenTwoDataFrames(self, dataFrameOriginal, dataFrameWeighted, legendLabelOriginal="",
                                     legendLabelWeighted="", title="", XLabel="", YLabel,
                                     fileName=None):
