...
class PowerForecasting:
    ...
    def predict_usage(self, data_frame, ptype='hour'):
        ...
        """
        # resampled_frame = data_frame.resample('1T', how='mean', closed='right')
        # span = len(resampled_frame) - 1
        # predicted_values = self._predict(data_frame=data_frame.reading, span=span, periods=60, freq='1T', adjust=False)
