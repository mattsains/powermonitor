...
class Resampling():
    ...
    def downsampleDateFrame(self, dateFrameIn, freq="1min", closedVal="left", labelVal="left", kindVal="timestamp",
                            howVal=None):
    ...
    def getListOfOutliers(self, dateFrameIn, freq="1min", closedVal="left", labelVal="left", kindVal="timestamp",
                          column="reading"):
        """
        This will take a Pandas DateFrame this dataFrame should be resampled
